...
<div class="list-group list-group-lg">
    ...
    <a href="#" class="list-group-item ">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/assets/src/images/people/a1.jpg" alt="...">
      </span>
      <div>
    ...
    <a href="#" class="list-group-item">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/assets/src/images/people/a2.jpg" alt="...">
      </span>
      <div>
    ...
    <a href="#" class="list-group-item">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/assets/src/images/people/a3.jpg" alt="...">
      </span>
      <div>
    ...
    <a href="#" class="list-group-item mb-n-md">
      <span class="thumb-sm mr">
          <img class="rounded-circle" src="/assets/src/images/people/a4.jpg" alt="...">
      </span>
      <div>
