      ...
      selectedMonthEvents: [
        {
          ...
          info: "Contents here",
          itemStyle: "#005690",
          date: moment(`${moment().year()}0${moment().month()+1}02`, "YYYYMMDD"),
        },
        {
          title: "Stop world water pollution",
          info: "Have a kick off meeting with .inc company",
          itemStyle: "#1A86D0",
          date: moment(`${moment().year()}0${moment().month()+1}05`, "YYYYMMDD"),
        },
        {
          title: "Light Blue 2.2 release",
          info: "Some contents here",
          itemStyle: "#FD5F00",
          date: moment(`${moment().year()}0${moment().month()+1}18`, "YYYYMMDD"),
        },
        {
          title: "A link",
          info: "",
          ...
          date: moment(`${moment().year()}0${moment().month()+1}29`, "YYYYMMDD"),
        },
      ],
      showEvents: false
    };
