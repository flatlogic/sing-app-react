...
/* eslint-disable */
import loadCalendar from 'bundle-loader?lazy!./components/calendar/Calendar';
import loadMap from 'bundle-loader?lazy!./components/mapael-map/MapaelMap';
import loadRickshaw from 'bundle-loader?lazy!./components/rickshaw/Rickshaw';
/* eslint-enable */
...
const CalendarBundle = Bundle.generateBundle(loadCalendar);
const MapBundle = Bundle.generateBundle(loadMap);
const RickshawGraph = Bundle.generateBundle(loadRickshaw);
              ...
              <div className="row progress-stats">
                ...
                <div className="col-md-3 col-12 text-center">
                  <span className="status rounded rounded-lg bg-body-light">
                    <small><AnimateNumber>75</AnimateNumber>%</small>
                  </span>
                </div>
              </div>
              <div className="row progress-stats">
                ...
                <div className="col-md-3 col-12 text-center">
                  <span className="status rounded rounded-lg bg-body-light">
                    <small><AnimateNumber>84</AnimateNumber>%</small>
                  </span>
                </div>
              </div>
              <div className="row progress-stats">
                ...
                <div className="col-md-3 col-12 text-center">
                  <span className="status rounded rounded-lg bg-body-light">
                    <small><AnimateNumber>92</AnimateNumber>%</small>
                  </span>
                </div>
              </div>
