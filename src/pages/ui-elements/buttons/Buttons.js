    ...
    return (
      <div className={s.root}>
        ...
        <Row>
          {/*Color options*/}
          <Col md={4} sm={6} xs={12}>
            <Widget title={<h5> Color <span className="fw-semi-bold">Options</span>
            </h5>} close collapse body={
              <div>
          ...
          {/*Size variants*/}
          <Col md={4} sm={6} xs={12}>
            <Widget title={<h5> Size <span className="fw-semi-bold">Variants</span>
            </h5>} close collapse body={
              <div>
                <p className="fs-mini text-muted">
          ...
          {/*Block Buttons*/}
          <Col md={4} sm={6} xs={12}>
            <Widget title={<h5> Block <span className="fw-semi-bold">Buttons</span>
            </h5>} close collapse body={
              <div>
                <p className="fs-mini text-muted">
                ...
                <Button color="secondary" block>Show Menu &nbsp;&nbsp;&nbsp;<i className="fa fa-bars"/></Button>
                <Button color="primary" block><i className="fa fa-facebook"/>&nbsp;&nbsp;Login mit Facebook</Button>
          ...
          {/*Disabled Buttons*/}
          <Col md={4} sm={6} xs={12}>
            <Widget title={<h5> Disabled <span className="fw-semi-bold">Buttons</span>
            </h5>} close collapse body={
              <div>
                <p className="fs-mini text-muted">
          ...
          {/*Buttons Groups*/}
          <Col md={4} sm={6} xs={12}>
            <Widget title={<h5> Button <span className="fw-semi-bold">Groups</span>
            </h5>} close collapse body={
              <div>
                <p className="fs-mini text-muted">
          ...
          {/*Button Dropdowns*/}
          <Col md={4} sm={6} xs={12}>
            <Widget title={<h5> Button <span className="fw-semi-bold">Dropdowns</span>
            </h5>} close collapse body={
              <div>
                <p className="fs-mini text-muted">
        ...
        <Row>
          <Col md={12} sm={12} xs={12}>
            <Widget title={<h6> Button <span className="fw-semi-bold">Options</span>
            </h6>} close collapse body={
              <Row>
                {/*Checkboxes*/}
                <Col md={4} sm={6} xs={12}>
                  ...
                  <p className="fs-mini text-muted">
                    ...
                    toolbars.
                    Use <code>ButtonGroup</code> to a group of checkboxes for checkbox style toggling on
                    btn-group.
                  </p>
                  <div className="mb-xs">
                    <ButtonGroup>
                      <Button color="secondary" onClick={() => this.onCheckboxBtnClickOne(1)}
                              active={this.state.cSelectedOne.includes(1)}>Left way</Button>
                      <Button color="secondary" onClick={() => this.onCheckboxBtnClickOne(2)}
                              active={this.state.cSelectedOne.includes(2)}>Middle way</Button>
                      <Button color="secondary" onClick={() => this.onCheckboxBtnClickOne(3)}
                              active={this.state.cSelectedOne.includes(3)}>Right way</Button>
                    </ButtonGroup>
                  </div>
                  <div className="mb-xs">
                    <ButtonGroup>
                      <Button size="sm" color="secondary" onClick={() => this.onCheckboxBtnClickTwo(1)}
                              active={this.state.cSelectedTwo.includes(1)}>Left way</Button>
                      <Button size="sm" color="secondary" onClick={() => this.onCheckboxBtnClickTwo(2)}
                              active={this.state.cSelectedTwo.includes(2)}>Middle way</Button>
                      <Button size="sm" color="secondary" onClick={() => this.onCheckboxBtnClickTwo(3)}
                              active={this.state.cSelectedTwo.includes(3)}>Right way</Button>
                    </ButtonGroup>
                  </div>
                ...
                <Col md={4} sm={6} xs={12}>
                  ...
                  <p className="fs-mini text-muted">
                    Do more with buttons. Control button states or create groups of buttons for more components like
                    toolbars.
                    Use <code>ButtonGroup</code> to a group of radio inputs for radio style toggling on
                    btn-group.
                  </p>
                  <div className="mb-xs">
                    <ButtonGroup>
                      <Button color="secondary" onClick={() => this.onRadioBtnClickOne(1)}
                              active={this.state.rSelectedOne === 1}>Left way</Button>
                      <Button color="secondary" onClick={() => this.onRadioBtnClickOne(2)}
                              active={this.state.rSelectedOne === 2}>Middle way</Button>
                      <Button color="secondary" onClick={() => this.onRadioBtnClickOne(3)}
                              active={this.state.rSelectedOne === 3}>Right way</Button>
                    </ButtonGroup>
                  </div>
                  <div className="mb-xs">
                    <ButtonGroup>
                      <Button size="sm" color="secondary" onClick={() => this.onRadioBtnClickTwo(1)}
                              active={this.state.rSelectedTwo === 1}>Left way</Button>
                      <Button size="sm" color="secondary" onClick={() => this.onRadioBtnClickTwo(2)}
                              active={this.state.rSelectedTwo === 2}>Middle way</Button>
                      <Button size="sm" color="secondary" onClick={() => this.onRadioBtnClickTwo(3)}
                              active={this.state.rSelectedTwo === 3}>Right way</Button>
                    </ButtonGroup>
                  </div>
                </Col>
                ...
                <Col md={4} sm={6} xs={12}>
                  ...
                  <p className="fs-mini text-muted">
                    Fontawesome and Glyph- icons may be used in buttons, button groups for a toolbar, navigation, or
