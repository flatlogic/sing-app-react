...
import TooltipItem from '../../../components/TooltipItem/TooltipItem.js';
  ...
  render() {
    return (
      <div className={s.root}>
        ...
        <Row>
          <Col md={12}>
            <Widget title={<h6> Alert <span className="fw-semi-bold">Messages</span></h6>}
                      ...
                      <div className="mb-5">
                        ...
                        <div>
                          {this.state.alerts.map((alert, index) =>
                            <Alert key={index} isOpen={alert.visible} toggle={() => this.closeAlert(index)}
                                   color={alert.type}>
              ...
              Labels & Badge <span className="fw-semi-bold">Options</span>
                    ...
                    body={
                      <div>
                        ...
                        <p>Just use <code>&lt;Badge&gt;</code> component to create inline badge element.</p>
                        <div>
                        ...
                        <p>Same as badges, just use <code>&lt;Badge pill&gt;</code> component to create inline
                          badge-pill. </p>
                        <p>
                      ...
                      <div>
                        ...
                        <div className="mb-5">
                          ...
                          <div>
                            ...
                            <Popover placement="left" isOpen={this.state.popoverOpenOne} target="Popover1"
                                     toggle={this.togglePopoverOne}>
                              <PopoverContent>And here's some amazing content. It's very engaging.
                            ...
                            <Popover placement="top" isOpen={this.state.popoverOpenTwo} target="Popover2"
                          ...
                          <Modal isOpen={this.state.modal} toggle={this.toggleModal} className={this.props.className}>
                            <ModalHeader>
                              ...
                              <h4 className="text-center fw-bold"
                                  id="myModalLabel18">One more step</h4>
                            ...
                            <ModalBody>
                              <Form>
                                <Row>
                                  <Col md={8} xs={12}>
                                    <FormGroup>
                                      <Input type="text" id="name" name="name" className="input-no-border"
                                             placeholder="Name"/>
                                    </FormGroup>
                                  </Col>
                                  <Col md={4} xs={12}>
                                    <FormGroup>
                                      <Input type="text" id="middle-name" name="middle-name" className="input-no-border"
                                ...
                                <Row>
                                  <Col md={12} xs={12}>
                                    <FormGroup>
                                      <Input type="text" id="address" name="address" className="input-no-border"
                                             placeholder="Address"/>
                                    </FormGroup>
                                  </Col>
                                </Row>
                                <Row>
                                  <Col md={4} xs={12}>
                                    <FormGroup>
                                      <Input type="text" id="city" name="city" className="input-no-border"
                                             placeholder="City"/>
                                    </FormGroup>
                                  </Col>
                                  <Col md={4} xs={12}>
                                    <FormGroup>
                                      <Input type="text" id="country" name="country" className="input-no-border"
                                             placeholder="Country"/>
                                    </FormGroup>
                                  </Col>
                                  <Col md={4} xs={12}>
                                    <FormGroup>
                                      <Input type="text" id="zip" name="zip" className="input-no-border"
                                             placeholder="Zip"/>
                                    </FormGroup>
                                  </Col>
                                </Row>
