    ...
    <Col lg={9}>
      ...
      <Widget id="Features">
        ...
        <ul className="mt">
          ...
          <li className="lead"><i className="la la-check" /> <a href="https://github.com/flatlogic/nodejs-backend" rel="noopener noreferrer" target="_blank">Node.js backend support</a></li>
