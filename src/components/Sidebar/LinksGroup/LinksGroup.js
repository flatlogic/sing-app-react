        ...
        return (
          <li className={classnames('link-wrapper', s.headerLink, this.props.className)}>
            ...
            >
              ...
              {this.props.header} {this.props.label && <sup className={`${s.headerLabel} text-danger`}>{this.props.label}</sup>}
          ...
          return (
            <li className={classnames('link-wrapper', { [s.headerLink]: this.props.isHeader }, this.props.className)}>
              ...
              >
                ...
                {this.props.header} {this.props.label && <sup className={`${s.headerLabel} ${s.headerNode} ml-1`}>{this.props.label}</sup>}
